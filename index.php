<?php
/**
 * Pagina principale biomedicinaintegrata.it
 * Ripristino immediato del sito
 */
?>
<!DOCTYPE html>
<html lang="it">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="gestionale-standalone.php">Gestionale</a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="col-md-8 text-center">
                    <div class="card border-primary">
                        <div class="card-header bg-primary text-white">
                            <h5><i class="fas fa-lock me-2"></i>Area Riservata Pazienti</h5>
                        </div>
                        <div class="card-body">
                            <p>Accesso tramite QR Code fornito durante la visita</p>
                            <a href="gestionale-standalone.php" class="btn btn-primary">
    ...
    <!-- Emergency Notice -->
    <?php if (file_exists('gestionale-auto-installer.php')): ?>
    <div class="position-fixed top-0 start-50 translate-middle-x" style="z-index: 9999; margin-top: 20px;">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="fas fa-exclamation-triangle me-2"></i>
            <strong>Sistema ripristinato!</strong> Il sito è tornato online. 
            <a href="gestionale-standalone.php" class="alert-link">Accedi al gestionale</a>
    ...
    <!-- Analytics per monitoraggio -->
    <script>
    console.log('Sito biomedicinaintegrata.it ripristinato:', new Date().toISOString());
    </script>
</body>
</html>