...
function AppRoutes() {
  ...
  return (
    ...
    <Switch>
      ...
      {/* Pagina pubblica promozioni - accesso diretto senza autenticazione */}
      <Route path="/promozioni/:code">
        <PromotionPage />
      </Route>
      ...
      {/* Campagne Marketing AI - Solo Pro+ */}
      <Route path="/campagne-marketing">
        <ProFeatureGuard 
          featureName="Campagne Marketing AI"
          description="Crea campagne marketing professionali con testo generato dall'intelligenza artificiale e carica immagini o video da allegare alle email."
          requiredCapability="marketing_ai"
        >
