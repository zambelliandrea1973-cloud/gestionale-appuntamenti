  ...
  const fallbackPlans: Plan[] = [
    {
      ...
      features: [
        { name: 'calendario appuntamenti, gestione clienti, notifiche clienti, emissione fatture', included: true },
        { name: 'richiesta appuntamenti cliente', included: true },
        { name: 'report e statistiche', included: false },
        { name: 'sincronizzazione google calendar qi', included: false },
    ...
    },
    {
      ...
      features: [
        { name: 'calendario appuntamenti, gestione clienti, notifiche clienti, emissione fatture, sincronizzazione google calendar qi', included: true },
        { name: 'richiesta appuntamenti cliente', included: true },
        { name: 'report e statistiche', included: true },
        { name: 'pacchetti promozionali', included: true },
        { name: 'gestione più dipendenti, magazzino prodotti', included: false },
    ...
    },
    {
      ...
      buttonVariant: 'outline',
      features: [
        { name: 'calendario appuntamenti, gestione clienti, notifiche clienti, emissione fatture, sincronizzazione google calendar qi, gestione più dipendenti, magazzino prodotti', included: true },
        { name: 'richiesta appuntamenti cliente', included: true },
        { name: 'report e statistiche', included: true },
        { name: 'pacchetti promozionali', included: true },
