...
export const notificationService = {
  ...
  async processReminders(): Promise<number> {
    try {
      console.log(`🗓️ [NOTIFICHE POSTGRESQL] Utilizzo filtro condiviso per appuntamenti di domani`);
      
      // 🎯 USA FUNZIONE CONDIVISA: Ora carica da PostgreSQL
      let appointments = await getTomorrowAppointments();
